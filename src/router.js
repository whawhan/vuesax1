    ...
    // =============================================================================
        ...
        // =============================================================================
                ...
                },
                {
                    path: '/myapp/todonew',
                    name: 'todonew',
                    component: () => import('./views/myapp/Todonew.vue'),
                    meta: {
                        rule: 'editor'
                    }
                },
                {
                    path: '/myapp/listpersonil',
                    name: 'personil',
                    component: () => import('./views/myapp/Listpersonil.vue'),
                    meta: {
                        breadcrumb: [
                            { title: 'Home', url: '/' },
                            { title: 'Data List'},
                            { title: 'Personil List View', active: true },
                        ],
                        pageTitle: 'Personil List View',
                        rule: 'editor'
                    },
                },
                {
                    ...
                    component: () => import('./views/myapp/Personil.vue'),
                    meta: {
                        breadcrumb: [
                            { title: 'Home', url: '/' },
                            { title: 'Data Detail'},
                            { title: 'Personil Detail View', active: true },
                        ],
                        pageTitle: 'Personil Detail View',
                        rule: 'editor'
                    },
                },
                {
                    path: '/myapp/newchat',
                    name: 'chat',
                    component: () => import('./views/myapp/NewChat.vue'),
                    meta: {
                        rule: 'editor'
                    }
                },
